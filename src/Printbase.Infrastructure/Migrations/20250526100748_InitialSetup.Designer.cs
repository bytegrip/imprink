...
namespace Printbase.Infrastructure.Migrations
{
    ...
    [Migration("20250526100748_InitialSetup")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Printbase.Domain.Entities.Address", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Printbase.Domain.Entities.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Printbase.Domain.Entities.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Printbase.Domain.Entities.OrderAddress", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Printbase.Domain.Entities.OrderItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Printbase.Domain.Entities.OrderStatus", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Printbase.Domain.Entities.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Printbase.Domain.Entities.ProductVariant", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Printbase.Domain.Entities.ShippingStatus", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Printbase.Domain.Entities.Category", b =>
                {
                    b.HasOne("Printbase.Domain.Entities.Category", "ParentCategory")
            ...
            modelBuilder.Entity("Printbase.Domain.Entities.Order", b =>
                {
                    b.HasOne("Printbase.Domain.Entities.OrderStatus", "OrderStatus")
                        .WithMany("Orders")
                        .HasForeignKey("OrderStatusId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Printbase.Domain.Entities.ShippingStatus", "ShippingStatus")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("Printbase.Domain.Entities.OrderAddress", b =>
                {
                    b.HasOne("Printbase.Domain.Entities.Order", "Order")
                        .WithOne("OrderAddress")
                        .HasForeignKey("Printbase.Domain.Entities.OrderAddress", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Printbase.Domain.Entities.OrderItem", b =>
                {
                    ...
                    b.HasOne("Printbase.Domain.Entities.Product", "Product")
                        .WithMany("OrderItems")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Printbase.Domain.Entities.ProductVariant", "ProductVariant")
                        .WithMany("OrderItems")
            ...
            modelBuilder.Entity("Printbase.Domain.Entities.Product", b =>
                {
                    b.HasOne("Printbase.Domain.Entities.Category", "Category")
                        .WithMany("Products")
